            ...
            {images.length > 0 ? (
              <Box sx={{ position: 'relative' }}>
                ...
                {images.length > 1 && (
                  <>
                    <IconButton
                      sx={{ position: 'absolute', left: 8, top: '50%', transform: 'translateY(-50%)', bgcolor: 'rgba(0,0,0,0.5)' }}
                      onClick={() => setCurrentImageIndex(prev => prev > 0 ? prev - 1 : images.length - 1)}
                    >
                      <NavigateBefore sx={{ color: 'white' }} />
                    </IconButton>
                    <IconButton
                      sx={{ position: 'absolute', right: 8, top: '50%', transform: 'translateY(-50%)', bgcolor: 'rgba(0,0,0,0.5)' }}
